...
import model2d3 from "../Images/model2d3.jpeg";
import model2d4 from "../Images/model2d4.jpg";
import model2d5 from "../Images/model2d5.jpg";
import model2d6 from "../Images/model2d6.jpg";
  ...
  return (
    <>    <div className="PortFolioSection">
      ...
      <div className="PortfolioContainer">
        ...
        <div className="PortfolioCard">
          <Image src={model2d5} width={0} height={0} sizes="100vw" className="PortfolioCardImage"/>
        </div>
        <div className="PortfolioCard">
