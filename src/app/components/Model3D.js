...
import Model3d1 from "../Images/model3d1.png";
import Model3d2 from "../Images/model3d2.jpg";
import Model3d3 from "../Images/model3d3.png";
import Model3d4 from "../Images/model3d4.jpg";
import Model3d5 from "../Images/model3d5.jpg";
import Model3d6 from "../Images/model3d6.png";
  ...
  return (
    <>    <div className="PortFolioSection">
      ...
      <div className="PortfolioContainer">
        ...
        <div className="PortfolioCard">
          <Image src={Model3d6} width={0} height={0} sizes="100vw" className="PortfolioCardImage"/>
        </div>
      </div>
    </div></>
  )
